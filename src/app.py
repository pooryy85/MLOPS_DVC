...
model = joblib.load('../model/logi-default.joblib') # This can be your Model Registry/or any cloud location
...
def diabetesPrediction():
           ...
           #df = df.drop(['Age','TemplateID'],axis=1)
            ...
            # Dataframe Creation
            df = df[['Pregnancies','Glucose','BloodPressure','SkinThickness','Insulin','BMI','DiabetesPedigreeFunction']]
